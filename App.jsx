...
// Import BrowserRouter, Routes, and Route for routing from react-router-dom.
// BrowserRouter is often conceptually referred to as the main Router component.
...
function App() {
  return (
    // BrowserRouter enables client-side routing. This acts as the main Router for the app.
    <BrowserRouter>
      <div style={{
